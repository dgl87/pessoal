...
namespace EstudoCSharp
{
    class ManualDeBolso
    {
        ...
        #region Dictionary - Chave Valor
        //Dictionary<string, string> cookies = new Dictionary<string, string>();
        //cookies["user"] = "maria";
        //    cookies["email"] = "maria@gmail.com";
        //    cookies["phone"] = "45138357";
        //    cookies["phone"] = "953813315";

        //    //mostra valor da chave phone
        //    Console.WriteLine(cookies["phone"]);

        //    //Remove valor da chave email
        //    cookies.Remove("email");

        //    //mostra tamanho do dictionary
        //    Console.WriteLine("Size: " + cookies.Count); 

        //    //mostra todo dictionary
